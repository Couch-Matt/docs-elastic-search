...
[[v4.4.15]]
== Version 4.4.15 (2026-05-20)

https://packages.couchbase.com/clients/connectors/elasticsearch/4.4.15/couchbase-elasticsearch-connector-4.4.15.zip[Download]

This version updates various dependencies to more recent versions.

=== Enhancements

* https://jira.issues.couchbase.com/browse/CBES-344[CBES-344]:
Upgraded `okhttp3` from `4.12.0` to `5.3.2`.

* https://jira.issues.couchbase.com/browse/CBES-346[CBES-346]:
Upgraded `log4j` from `2.23.1` to `2.25.4`.

* https://jira.issues.couchbase.com/browse/CBES-347[CBES-347]:
Ensure transitive dependency on `vertx-core` is version `4.5.27` or higher.

* https://jira.issues.couchbase.com/browse/CBES-348[CBES-348]:
Upgraded `netty` from `4.1.119` to `4.1.133`.

[[v4.4.14]]
== Version 4.4.14 (2025-10-23)

https://packages.couchbase.com/clients/connectors/elasticsearch/4.4.14/couchbase-elasticsearch-connector-4.4.14.zip[Download]
...
If the connector is unable to connect to Couchbase Server after the upgrade, you might need to specify `network = 'default'` in the `[couchbase]` section of your connector config.
...
+
TIP: If this change causes the connector to select the incorrect network for your deployment (you'll know because the connector will be unable to connect to the Couchbase Server cluster), specify `network = 'default'` in the `[couchbase]` section of your connector config to force the connector to use the same network as before.


=== Enhancements

* https://jira.issues.couchbase.com/browse/CBES-337[CBES-337]: Connector metrics are now tagged with "bucket" and "clusterUuid".

* https://jira.issues.couchbase.com/browse/CBES-338[CBES-338]:
Upgraded Couchbase Java SDK from `3.8.0` to `3.9.2`.

* https://jira.issues.couchbase.com/browse/CBES-339[CBES-339]:
Upgraded DCP client from `0.54.0` to `0.56.0`.
